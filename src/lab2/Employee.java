...
public class Employee {
    ...
    public void orientationDayActivity(String cubeId){
    ...
    public void setSsn(String ssn) {
        if(ssn == null || ssn.length() < 9 || ssn.length() > 10){
    ...
    public void setCubeId(String cubeId) {
        if(cubeId == null || cubeId.isEmpty()){
            System.out.println("Please enter a valid cube id.");
        }else{
        this.cubeId = cubeId;
        }
    }
