...
public class Employee {
    ...
    private EmployeeReportingService reportService;
    private DateUtility formattedDate;
    ...
    public Employee(String firstName, String lastName, String ssn) {
        ...
        setSsn(ssn);
        reportService = new EmployeeReportingService();
        formattedDate = new DateUtility();
    }
    ...
    */
    ...
    private void meetWithHrForBenefitAndSalryInfo() {
        ...
        reportService.doOutput(firstName + " " + lastName + " met with Hr on "
            + formattedDate.getFormattedDate(orientationDate));
    }
    ...
    public void moveIntoCubicle(String cubeId) {
        ...
        reportService.doOutput(firstName + " " + lastName + " moved into cubicle "
                + cubeId + " on " + formattedDate.getFormattedDate(orientationDate));
    }
